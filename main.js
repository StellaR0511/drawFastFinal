...
document.getElementById("draw").innerHTML = "~ Draw This Fast: "+sketch+" ~";
...
function gotResult(error,results){
    if(error){
        ...
        document.getElementById("label").innerHTML = "What You Drew: "+drawn_sketch;
        document.getElementById("confidence").innerHTML = "How Sure We Are: "+Math.round(results[0].confidence*100)+"%";
    }
}
